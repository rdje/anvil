...
- latest_commit: **`4ad09a4`** (`NEGATIVE-CONTROL-HARNESS.1`). Prior: `da73827`, `3b0d2c2`, `425c0ca`. Recent decisions: **`0040`–`0046`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
