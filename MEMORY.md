...
- latest_commit: **`cd7f24b`** (`USER-GUIDE-CLI-TABLE-SHADOW.2`). Prior: `f2d282e`, `2203574`, `beb1ebb`. Recent decisions: **`0040`–`0045`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
