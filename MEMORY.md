...
- latest_commit: **`9a7772b`** (`USER-GUIDE-CLI-TABLE-SHADOW.3`). Prior: `c793cf3`, `cd7f24b`, `f2d282e`. Recent decisions: **`0040`–`0045`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
