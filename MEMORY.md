...
- latest_commit: **`CHANGES-ENTRY-PLACEMENT.4`** (backfill next commit). Prior: `928817f`, `f0eb8fb`, `955e387`. Recent decisions: **`0040`–`0045`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
