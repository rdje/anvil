...
- latest_commit: **`OVERFLOW-DESTINATION-INSTRUMENTATION.3`** (`e801617`). Prior: `6c0c953`+`c1b765c` (`.5b`), `4f3d508` (`.5a` = decision `0041`), `4a91c45` (`.2` = decision `0040`). Recent decisions: **`0039`–`0041`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
