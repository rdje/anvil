...
## Recent commits
- `415818c` — Docs: BOOK-EXAMPLES-RUNNABLE.2.1 migrate book examples to `cargo run --release --` (45 bash heads across factorization/knobs/recipes; missed=0; 9 rust sketches→rust,ignore; shorthand note; spot-runs incl. full multi-line recipe→50 .sv exit 0). Book/docs only, no code; published book now copy-paste-correct.
