...
- Latest full downstream-clean Phase 4 hierarchy bank is:
  ...
  support into the helper-sourced D cone below the top parent.
  Focused regressions:
  ...
  are now historical breadcrumbs.
- Latest Phase 4 hierarchy slice lets registered parent-composed helper
...
- **Last completed slice:** Banked recursive non-top registered
  parent-cone helper mixed-support child-input routing through full
  downstream tools at
  `/tmp/anvil-tool-matrix-phase4-hierarchy-r48/tool_matrix_report.json`
  ...
  recursive registered multistage mixed-support no-helper bank.
...
- **Prior slice:** Landed registered parent-composed child-input
  ...
  The current full `r47` gate supersedes that historical report with
