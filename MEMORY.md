...
- Latest full downstream-clean Phase 4 hierarchy bank is:
  ...
  covers the live `144`-scenario policy at `4` designs/scenario
  (`576` total designs), with `artifact_kind = "design"`,
...
- Current Phase 4 hierarchy r65 batch extends the depth-4 axis by
