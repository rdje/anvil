...
- latest_commit: **`CAPABILITY-BREADTH-EXPANSION.3`** (backfill next commit). Prior: `9bf2420`, `8a6dcf3`, `1b1793e`. Recent decisions: **`0040`–`0044`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
