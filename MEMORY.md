...
- latest_commit: **`83a2a5b`** (`NEGATIVE-CONTROL-HARNESS.1`). Prior: `4ad09a4`, `da73827`, `3b0d2c2`. Recent decisions: **`0040`–`0047`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
