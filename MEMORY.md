...
- latest_commit: **`2203574`** (`CHANGES-ENTRY-PLACEMENT.5`). Prior: `beb1ebb`, `8c93d1e`, `1cd46c3`. Recent decisions: **`0040`–`0045`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
