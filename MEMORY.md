...
- latest_commit: **`3b0d2c2`** (`NEGATIVE-CONTROL-HARNESS.0`). Prior: `425c0ca`, `9ad7385`, `3a48cc4`. Recent decisions: **`0040`–`0046`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
