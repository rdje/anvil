...
- latest_commit: **`OVERFLOW-DESTINATION-INSTRUMENTATION.5b`** (`6c0c953`). Prior: `4f3d508`+`62f9e21` (`.5a`), `4a91c45` (`.2` = decision `0040`), `8473821` (`.6`). Recent decisions: **`0039`–`0041`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
