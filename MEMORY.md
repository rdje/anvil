...
- Latest full downstream-clean Phase 4 hierarchy bank is:
  ...
  non-top registered sibling multistage no-helper bank are now
...
- **Last completed slice:** Banked recursive non-top multi-stage
  registered mixed-support no-helper child-input routing through full
  downstream tools at
  `/tmp/anvil-tool-matrix-phase4-hierarchy-r47/tool_matrix_report.json`
  ...
  registered sibling multistage no-helper bank.
