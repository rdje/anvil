...
- Latest full downstream-clean Phase 4 hierarchy bank is:
  ...
  covers the live `108`-scenario policy at `4` designs/scenario
  (`444` total designs), with `artifact_kind = "design"`,
...
- Current Phase 4 hierarchy r54 batch proves recursive non-top parent outputs
...
- Previous Phase 4 hierarchy r53 batch proves recursive non-top unregistered
  ...
  `444/0` pass-fail in Verilator plus both repo-owned Yosys modes. The
...
- **Prior slice:** Landed registered parent-composed child-input
  ...
  The current full `r54` gate supersedes that historical report with
  `coverage_gaps = []`, `444/0` pass-fail in Verilator plus both
