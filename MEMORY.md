...
- latest_commit: **`6e95494`** (`USER-GUIDE-CLI-TABLE-SHADOW.6`). Prior: `04ef949`, `9b73e80`, `176c868`. Recent decisions: **`0040`–`0045`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
