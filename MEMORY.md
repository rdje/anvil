...
- **Last completed slice:** Banked recursive non-top multi-helper
  budget evidence through full downstream
  tools at
  `/tmp/anvil-tool-matrix-phase4-hierarchy-r41/tool_matrix_report.json`
  ...
  parent-output helper bank, and the `r40` recursive non-top stateful
...
- **Prior slice:** Landed registered parent-composed child-input
  ...
  The current full `r41` gate supersedes that historical report with
