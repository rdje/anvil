...
- latest_commit: **`3a48cc4`** (`BOOK-LINK-INTEGRITY.2`). Prior: `8ff64cd`, `5e3e9a0`, `614e977`. Recent decisions: **`0040`–`0046`**. Older commits NOT listed (`MEMORY_ARCHITECTURE.md` §12) — use `git log --oneline`.
