...
(768 designs, `artifact_kind = "design"`, `coverage_gaps = []`, and
768/0 pass-fail in Verilator plus both repo-owned Yosys modes). That
...
remain useful focused policy breadcrumbs, while the current full `r81`
