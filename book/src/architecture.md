...
(672 designs, `artifact_kind = "design"`, `coverage_gaps = []`, and
672/0 pass-fail in Verilator plus both repo-owned Yosys modes). That
...
remain useful focused policy breadcrumbs, while the current full `r73`
