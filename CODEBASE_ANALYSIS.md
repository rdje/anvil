...
3. **Tool-clean confidence is still under-automated**
   ...
   `/tmp/anvil-tool-matrix-phase1-real-r21` already banked through 675
   completed checkpoints / 676 emitted files with zero warning
...
│                     (`r21`) at 675 completed checkpoints / 676
