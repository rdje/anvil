...
- Current executed counts (`cargo test`, 2026-04-23): **168 unit-target tests + 29 integration tests = 197 passing tests**. Doc-tests: 0.
- No external Verilator / Yosys smoke tests are wired into `cargo test`
  ...
  now belongs to hierarchy, advanced motifs, and later artifact
  families rather than basic leaf-kernel viability.
