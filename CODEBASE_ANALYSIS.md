...
3. **Tool-clean confidence is still under-automated**
   ...
   `/tmp/anvil-tool-matrix-phase1-real-r21` already banked through 702
   completed checkpoints / 703 emitted files with zero warning
   artifacts, including full clean closure of every interleaved `int_*`
   scenario through `e-graph`, full clean closure of
   `seq_nodeid_egraph_share_heavy_comb_only`, and 32 clean checkpoints
...
│                     (`r21`) at 702 completed checkpoints / 703
