...
through `--artifact <dut|microdesign|frontend>`. The current frontier is
not "create those lanes" anymore; it is to deepen their signoff surface,
broaden supported source-language constructs, and keep optional
real-tool parity gates honest about what each tool can introspect.
