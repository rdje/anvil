...
3. **Tool-clean confidence is still under-automated**
   ...
   `/tmp/anvil-tool-matrix-phase1-real-r21` already banked through 804
   completed checkpoints / 804 emitted files with zero warning
   ...
   `seq_nodeid_egraph_motif_heavy_seq`, and
   `shuf_nodeid_egraph_share_heavy_comb_only`, plus a newer same-binary
...
│                     (`r21`) at 804 completed checkpoints / 804
