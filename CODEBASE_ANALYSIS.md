...
│                     (`r20`) at 482 completed checkpoints / 483
...
│                     into evidence only; `r18` is historical while
│                     `r20` matches current code.
│
├── ir/
