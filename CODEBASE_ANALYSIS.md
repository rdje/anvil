...
- Current executed counts (`cargo test`, 2026-04-22): **149 unit-target tests + 24 integration tests = 173 passing tests**. Doc-tests: 0.
...
- `cargo test` — clean (173 passing tests: 129 lib + 5 main + 15 tool_matrix + 24 integration).
- `cargo build` — clean.
