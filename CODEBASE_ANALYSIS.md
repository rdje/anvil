...
3. **Tool-clean confidence is still under-automated**
   ...
   `/tmp/anvil-tool-matrix-phase1-real-r21` already banked through 508
   completed checkpoints / 509 emitted files with zero warning
...
│                     (`r21`) at 508 completed checkpoints / 509
