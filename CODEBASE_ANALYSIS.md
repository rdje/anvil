...
3. **Tool-clean confidence is still under-automated**
   ...
   `/tmp/anvil-tool-matrix-phase1-real-r21` already banked through 559
   completed checkpoints / 559 emitted files with zero warning
   artifacts, a newer same-binary fast-resume path that can skip
...
│                     (`r21`) at 559 completed checkpoints / 559
