...
| `SIGNOFF-SURFACE-EXPANSION` | `active` | Quality / signoff-level downstream confidence | `SIGNOFF-SURFACE-EXPANSION.3` — broader simulator/tool parity or resource-aware sweep where practical | [docs/tasks/SIGNOFF-SURFACE-EXPANSION.md](tasks/SIGNOFF-SURFACE-EXPANSION.md) |
