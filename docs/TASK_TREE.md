...
| `MEMORY-STATE-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `MEMORY-STATE-IDENTITY.3` — close reset-defined memory-state frontier | [docs/tasks/MEMORY-STATE-IDENTITY.md](tasks/MEMORY-STATE-IDENTITY.md) |
