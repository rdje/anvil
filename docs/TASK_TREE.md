...
| `MEMORY-ARCHITECTURE-DOC` | `active` | Workflow / memory architecture | `MEMORY-ARCHITECTURE-DOC.5` pending — run final focused validation, sync live docs, and close the tree. | [docs/tasks/MEMORY-ARCHITECTURE-DOC.md](tasks/MEMORY-ARCHITECTURE-DOC.md) |
