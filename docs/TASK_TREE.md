...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2.3` (`.2.1` container + `.2.2` structural-contract/factorization-opacity proof done; generated memory spot-checked `1 $mem_v2`; `.3` FSM pending) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
