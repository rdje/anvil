...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2.1a` (`.1` done; `.2` split `.2.1`–`.2.4`; `.2.1` split `.2.1a`/`.2.1b` on a discovered compaction-reachability dependency; `.3` FSM pending) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
