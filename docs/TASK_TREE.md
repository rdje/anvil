...
| `PHASE-5B-AGGREGATES` | `active` | Phase 5b — Synthesizable aggregates | `PHASE-5B-AGGREGATES.2.1` (`.1` design done; `.2` split into `.2.1`–`.2.4` per Splitting Rules + r87 no-aspirational-claims) | [docs/tasks/PHASE-5B-AGGREGATES.md](tasks/PHASE-5B-AGGREGATES.md) |
