...
| `MEMORY-ARCHITECTURE-DOC` | `active` | Workflow / memory architecture | `MEMORY-ARCHITECTURE-DOC.2` pending — add the layer-C decision-record store and initial migrated decisions/facts. | [docs/tasks/MEMORY-ARCHITECTURE-DOC.md](tasks/MEMORY-ARCHITECTURE-DOC.md) |
