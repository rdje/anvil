...
| `SEQUENTIAL-COINDUCTIVE-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `SEQUENTIAL-COINDUCTIVE-IDENTITY.2.1` — add clock-domain proof input to existing flop identity | [docs/tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md](tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md) |
