...
| `HIERARCHY-SEMANTIC-IDENTITY` | `active` | NodeId as identity / hierarchical module identity | `HIERARCHY-SEMANTIC-IDENTITY.2` — evaluate the next safe module-equivalence class beyond pure combinational leaves or record blocker evidence | [docs/tasks/HIERARCHY-SEMANTIC-IDENTITY.md](tasks/HIERARCHY-SEMANTIC-IDENTITY.md) |
