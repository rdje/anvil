...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2.2` (`.2.1` container complete: `.2.1a` IR core+reachability, `.2.1b` `memory_prob`+rules-first `build_memory_leaf`; generated memory spot-checked `1 $mem_v2`; `.3` FSM pending) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
