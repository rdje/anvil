...
| `SEQUENTIAL-COINDUCTIVE-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `SEQUENTIAL-COINDUCTIVE-IDENTITY.3` — close the sequential identity frontier | [docs/tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md](tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md) |
