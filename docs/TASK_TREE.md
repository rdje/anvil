...
| `MEMORY-ARCHITECTURE-DOC` | `active` | Workflow / memory architecture | `MEMORY-ARCHITECTURE-DOC.3` pending — demote `MEMORY.md` to the bounded layer-A resume pointer. | [docs/tasks/MEMORY-ARCHITECTURE-DOC.md](tasks/MEMORY-ARCHITECTURE-DOC.md) |
