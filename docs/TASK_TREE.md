...
| `SEQUENTIAL-COINDUCTIVE-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `SEQUENTIAL-COINDUCTIVE-IDENTITY.2.2` — implement reset-defined self-hold coinductive flop identity | [docs/tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md](tasks/SEQUENTIAL-COINDUCTIVE-IDENTITY.md) |
