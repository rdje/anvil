...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2.4` (`.2.1`/`.2.2`/`.2.3` done — IR+knob+proofs+`phase6_inferrable_memory` scenario/metric/gap, bin 219/876, non-vacuous; `.3` FSM pending) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
