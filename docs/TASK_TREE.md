...
| --- | --- | --- | --- | --- |
| `COMBINATIONAL-SEMANTIC-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `COMBINATIONAL-SEMANTIC-IDENTITY.2` — audit bounded proof budgets after gate-to-endpoint fold landed | [docs/tasks/COMBINATIONAL-SEMANTIC-IDENTITY.md](tasks/COMBINATIONAL-SEMANTIC-IDENTITY.md) |
