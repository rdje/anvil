...
| `SIGNOFF-SURFACE-EXPANSION` | `active` | Quality / signoff-level downstream confidence | `SIGNOFF-SURFACE-EXPANSION.4` — closeout and explicit frontier/blocker recording (`pending`) | [docs/tasks/SIGNOFF-SURFACE-EXPANSION.md](tasks/SIGNOFF-SURFACE-EXPANSION.md) |
