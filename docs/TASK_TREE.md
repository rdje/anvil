...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2` (`.1` memory design done 2026-05-18 — architecture (M) `Memory` block + `MemRead` leaf; Yosys `$mem_v2` probe clean both modes) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
