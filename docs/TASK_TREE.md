...
| `PHASE-6-ADVANCED-MOTIFS` | `active` | Phase 6 — Advanced motifs | `PHASE-6-ADVANCED-MOTIFS.2.1b` (`.2.1a` IR core + opaque-stateful-leaf pipeline integration incl. load-bearing compaction-reachability + 3 unit proofs landed; `.3` FSM pending) | [docs/tasks/PHASE-6-ADVANCED-MOTIFS.md](tasks/PHASE-6-ADVANCED-MOTIFS.md) |
