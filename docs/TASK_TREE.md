...
| `HIERARCHY-SEMANTIC-IDENTITY` | `active` | NodeId as identity / hierarchical module identity | `HIERARCHY-SEMANTIC-IDENTITY.3` — close the semantic module-identity frontier with landed classes and blockers | [docs/tasks/HIERARCHY-SEMANTIC-IDENTITY.md](tasks/HIERARCHY-SEMANTIC-IDENTITY.md) |
