...
| `PHASE-5-PARAMETERIZATION` | `active` | Phase 5 — Parameterization | `PHASE-5-PARAMETERIZATION.2.4b` (`.2.4a` gate scenario+metrics done; `.2.4b` = run real gate → verify → promote Phase 5 done) | [docs/tasks/PHASE-5-PARAMETERIZATION.md](tasks/PHASE-5-PARAMETERIZATION.md) |
