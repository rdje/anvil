...
| `KNOWLEDGE-MAP-DOC` | `active` | Workflow / retrieval architecture | `KNOWLEDGE-MAP-DOC.3` pending — seed ANVIL-specific retrieval keys and close the Knowledge Map adoption tree. | [docs/tasks/KNOWLEDGE-MAP-DOC.md](tasks/KNOWLEDGE-MAP-DOC.md) |
