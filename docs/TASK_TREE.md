...
| `MEMORY-STATE-IDENTITY` | `active` | NodeId as identity / full-factorization mode | `MEMORY-STATE-IDENTITY.2` — record reset-defined memory identity blocker for current memory-inference lane | [docs/tasks/MEMORY-STATE-IDENTITY.md](tasks/MEMORY-STATE-IDENTITY.md) |
