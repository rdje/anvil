...
| `PHASE-5B-AGGREGATES` | `active` | Phase 5b — Synthesizable aggregates | `PHASE-5B-AGGREGATES.2.2` (`.2.1` scaffold landed: IR annotation + `aggregate_prob` knob + emitter projection, default-off byte-identical, projected design verilator-clean) | [docs/tasks/PHASE-5B-AGGREGATES.md](tasks/PHASE-5B-AGGREGATES.md) |
