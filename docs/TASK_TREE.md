...
| --- | --- | --- | --- | --- |
| `HIERARCHY-AWARE-IDENTITY` | `active` | Phase 4 — Hierarchy | `HIERARCHY-AWARE-IDENTITY.1` | [docs/tasks/HIERARCHY-AWARE-IDENTITY.md](tasks/HIERARCHY-AWARE-IDENTITY.md) |
...
| `COVERAGE-INSTRUMENTATION` | `active` | Quality — test-discipline visibility | `COVERAGE-INSTRUMENTATION.1` | [docs/tasks/COVERAGE-INSTRUMENTATION.md](tasks/COVERAGE-INSTRUMENTATION.md) |
