...
| `MEMORY-ARCHITECTURE-DOC` | `active` | Workflow / memory architecture | `MEMORY-ARCHITECTURE-DOC.4` pending — install the memory-architecture enforcement kit. | [docs/tasks/MEMORY-ARCHITECTURE-DOC.md](tasks/MEMORY-ARCHITECTURE-DOC.md) |
