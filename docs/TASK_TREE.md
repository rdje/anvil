...
| `SIGNOFF-SURFACE-EXPANSION` | `active` | Quality / signoff-level downstream confidence | `SIGNOFF-SURFACE-EXPANSION.2` — richer AST/source extractor parity where available | [docs/tasks/SIGNOFF-SURFACE-EXPANSION.md](tasks/SIGNOFF-SURFACE-EXPANSION.md) |
