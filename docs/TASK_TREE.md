...
| `PHASE-5B-AGGREGATES` | `active` | Phase 5b — Synthesizable aggregates | `PHASE-5B-AGGREGATES.2.4` (`.2.3` landed `phase5b_packed_aggregate` matrix scenario + metric + `saw_packed_aggregate_design` fact/gap; bin 213→216/852→864; scenario proven non-vacuous) | [docs/tasks/PHASE-5B-AGGREGATES.md](tasks/PHASE-5B-AGGREGATES.md) |
