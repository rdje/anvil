...
| `KNOWLEDGE-MAP-DOC` | `active` | Workflow / retrieval architecture | `KNOWLEDGE-MAP-DOC.2` pending — install generation/enforcement for the Knowledge Map. | [docs/tasks/KNOWLEDGE-MAP-DOC.md](tasks/KNOWLEDGE-MAP-DOC.md) |
