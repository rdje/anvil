...
- Created: `2026-06-15`
- Last updated: `2026-06-23` (**`.19b.2a` landed — the ninth-surface metric + introspection
  ...
  `.19b.2a` (this) + `.19b.2b` (the repo-owned `tool_matrix --casez-mux-if-gate`); frontier →
  `.19b.2b`. Default-off / DUT byte-identical. The lane stays `active`.**) Prior: **`.19b.1` landed — the LIVE ninth structured surface (the
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b`
  ...
  Result: `In progress. .19b.1 (the live source change) done 2026-06-23; .19b.2 (metric + schema 1.16→1.17 + the repo-owned tool_matrix --casez-mux-if-gate) and .19b.3 (book/USER_GUIDE/README/KM docs) pending. Frontier → .19b.2.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b.2`
  ...
  Result: `In progress. .19b.2a (metric + schema 1.17) done 2026-06-23; .19b.2b (the repo-owned tool_matrix --casez-mux-if-gate) pending. Frontier → .19b.2b.`
...
**Current frontier → `STRUCTURED-EMISSION-EXPANSION.19b.2b` (the repo-owned `tool_matrix
--casez-mux-if-gate`).** **The NINTH structured surface is LIVE + metered (`.18` + `.19a` +
`.19b.1` + `.19b.2a` done).** `.19b.2a` (done) added
...
| --- | --- | --- |
| `STRUCTURED-EMISSION-EXPANSION.19b.2a` | `STRUCTURED-EMISSION-EXPANSION.19b.2a — casez-mux-if metric + introspection schema 1.17` | Metric + schema bump. `Metrics::num_emitted_casez_mux_if_chains` (`= m.casez_mux_if_gates.len()`, exact) + a lib proof ⇒ introspection schema `1.16 → 1.17` across all current-output refs (introspect/mcp assertions, schema doc + a `1.16→1.17` changelog entry, README/USER_GUIDE/CODEBASE envelope); per-metric landing attributions intact, book JSONs deferred to `.19b.3`. `cargo test --lib` 636, snapshots 6/6 byte-identical; live `--introspect` `1.17` + `0`/`1`. Default-off / DUT byte-identical. Frontier → `.19b.2b`. |
