...
- Created: `2026-06-15`
- Last updated: `2026-06-23` (**`.19a` landed — the ninth-surface impl design-detail
...
**Current frontier → `STRUCTURED-EMISSION-EXPANSION.19b.1` (the live source change).**
**The NINTH structured surface is picked + design-detailed (`.18` + `.19a` done).** `.19a`
