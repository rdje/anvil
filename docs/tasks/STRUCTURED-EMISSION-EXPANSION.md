...
- Created: `2026-06-15`
- Last updated: `2026-06-23` (**`.19b.2b` landed — the ninth-surface repo-owned downstream
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19`
  ...
  Result: `In progress. .19a (impl design-detail, DEVELOPMENT_NOTES.md, no source) done 2026-06-23; .19b (the live impl, pre-split .19b.1 live / .19b.2 metric+gate / .19b.3 docs) pending. Frontier → .19b.1.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b`
  ...
  Result: `In progress. .19b.1 (the live source change) done 2026-06-23; .19b.2 (metric + schema 1.16→1.17 [.19b.2a] + the repo-owned tool_matrix --casez-mux-if-gate [.19b.2b, banked clean /tmp/anvil-casez-mux-if-gate-r1]) done 2026-06-23; .19b.3 (book/USER_GUIDE/README/KM docs) pending. Frontier → .19b.3.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b.2b`
  ...
  Commit: `this STRUCTURED-EMISSION-EXPANSION.19b.2b commit`
...
**Current frontier → `STRUCTURED-EMISSION-EXPANSION.19b.3` (the ninth-surface user docs).**
**The NINTH structured surface is LIVE + metered + GATED (`.18` + `.19a` + `.19b.1` + `.19b.2a`
+ `.19b.2b` done).** `.19b.2b` (done) landed the repo-owned `tool_matrix --casez-mux-if-gate`
