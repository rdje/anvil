...
- Last updated: `2026-06-23` (**`.19b.3` landed — the ninth-surface user docs (DOCS-ONLY ⇒
  ...
  snapshots 6/6 byte-identical. Banked clean `/tmp/anvil-casez-mux-if-gate-r1`: 3 scenarios /
  ...
  **masked** priority-chain emit-projection of a dynamic-selector `CasezMux` gate (decision
  ...
  proofs); snapshots 6/6 byte-identical. Banked clean `/tmp/anvil-case-mux-if-gate-r1`
  ...
  **Simpler than the seventh surface** — a `CaseMux` is already an `always_comb`-written
  ...
  `/tmp/anvil-mux-if-gate-r1` (3 scenarios / 12 modules, `coverage_gaps = []`,
  ...
  `mux_if_emit_prob=1.0` sweep (`/tmp/anvil-muxif-genproof.*`): every plain mux
  ...
  `/tmp/anvil-mo-k3-gate-r1` `coverage_gaps = []` / `12/0` all tools with a k=3
  ...
  **`.12b.3` landed — the multi-output task user-facing
  ...
  `/tmp/anvil-multi-output-task-gate-r1` (3 scenarios / 12 modules / 6 emitting /
  ...
  **`.12b.2a` landed — the multi-output task metric +
  ...
  sweep `/tmp/anvil-mo-sweep/` Verilator -Wall Δ=0 + Yosys both + Icarus clean +
  ...
  `--task-emit-gate`. Banked clean `/tmp/anvil-cone-function-gate-r1` (3 scenarios
  ...
  test --lib` 493→501; snapshots 6/6). Forced sweep `/tmp/anvil-cf-sweep/` (8 seeds,
...
- ID: `STRUCTURED-EMISSION-EXPANSION.12`
  ...
  Result: `Done (closed by .12b.3, 2026-06-22). The sixth structured surface (the multi-output combinational task automatic emit-projection, decision 0025) is delivered end-to-end: .12a (design-detail) + .12b.1 (live surface: knob + flag + Module field + src/ir/multi_output_task_emit.rs + emitter + 11 proofs + forced sweep) + .12b.2a (metric + introspection schema 1.13->1.14) + .12b.2b (the repo-owned tool_matrix --multi-output-task-gate, banked clean /tmp/anvil-multi-output-task-gate-r1) + .12b.3 (book/USER_GUIDE/README/KM docs + the deferred book schema-JSON refresh). Default-off / DUT byte-identical throughout (snapshots 6/6). Nothing retired.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.12b.2`
  ...
  Result: `Done. .12b.2a (metric + introspection schema 1.13->1.14) + .12b.2b (the repo-owned tool_matrix --multi-output-task-gate, banked clean /tmp/anvil-multi-output-task-gate-r1) both complete. Default-off / DUT byte-identical. Frontier → .12b.3 (docs).`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.15b.1`
  ...
  Verification: `cargo check --all-targets clean; cargo fmt --all --check clean; cargo clippy --all-targets -- -D warnings clean; cargo test --lib 615 passed / 2 ignored (605 + 10 new mux_if proofs; umbrella DUT-byte-identical proofs green); cargo test --test snapshots 6/6 byte-identical (default-off — the 0.0 path never calls the pass). Forced mux_if_emit_prob=1.0 sweep /tmp/anvil-muxif-genproof.*: across seeds 1/2/3/7/11 every plain Mux (121/143/132/144/195) projects to a __cv always_comb if/else block (ON __cv == OFF mux count exactly); Verilator --lint-only -Wall warning count ON == OFF (Δ=0) on all five (the pre-existing UNUSEDSIGNAL/etc warnings are identical ON/OFF — the projection adds none); Yosys synth -noabc and abc -fast; opt -fast; check both report 0 warnings/errors; iverilog -g2012 compiles (rc=0). Comb-only ON-vs-OFF sim-equiv (seed 3, --flop-prob 0 --comb-mux-prob 0.9, 128 muxes): iverilog+vvp prove the ON module bit-equal to OFF across 20000 random vectors on all 3 outputs (GEN-RTL SIM-EQUIV OK). The standalone construct probe (this session) already proved the if/else === (sel)?(a):(b) ternary over 20000 vectors. dump-config surfaces mux_if_emit_prob.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19`
  ...
  Result: `Done 2026-06-23. .19a (impl design-detail, DEVELOPMENT_NOTES.md, no source) + .19b (the live impl: .19b.1 live source / .19b.2 metric+gate [.19b.2a schema 1.17 / .19b.2b tool_matrix --casez-mux-if-gate, banked clean /tmp/anvil-casez-mux-if-gate-r1] / .19b.3 docs) all done. The NINTH structured surface — the procedural always_comb if/else if MASKED priority chain (sel & care_mask) == value_masked projecting a wildcard CasezMux (decision 0029) — is delivered end-to-end: live behind casez_mux_if_emit_prob, metered at introspection schema 1.17, proven downstream-clean, and documented in the book/knobs/USER_GUIDE/README/KM.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b`
  ...
  Result: `Done. .19b.1 (the live source change) done 2026-06-23; .19b.2 (metric + schema 1.16→1.17 [.19b.2a] + the repo-owned tool_matrix --casez-mux-if-gate [.19b.2b, banked clean /tmp/anvil-casez-mux-if-gate-r1]) done 2026-06-23; .19b.3 (book ninth-surface section + chapter-intro list + knobs/USER_GUIDE/README entries + the deferred book example-JSON 1.16→1.17 + a casez-mux-if-emit KM card / KNOWLEDGE_MAP.md regenerated) done 2026-06-23. .19b closes ⇒ .19 closes ⇒ the NINTH structured surface is delivered end-to-end.`
...
- ID: `STRUCTURED-EMISSION-EXPANSION.19b.2`
  ...
  Result: `Done. .19b.2a (metric + schema 1.17) done 2026-06-23; .19b.2b (the repo-owned tool_matrix --casez-mux-if-gate, banked clean /tmp/anvil-casez-mux-if-gate-r1: 12/12 emitting / 108 chains / coverage_gaps = [] / 12/0 Verilator + both Yosys + Icarus) done 2026-06-23. .19b.2 closes; frontier → .19b.3 (docs).`
...
`/tmp/anvil-casez-mux-if-gate-r1`: 3 scenarios / 12 modules / 12 emitting a chain / 108 chains /
...
`/tmp/anvil-cone-function-gate-r1`, introspection schema `1.11`), and the
...
`.12b.3` user docs; banked clean `/tmp/anvil-multi-output-task-gate-r1` — a
...
- `2026-06-22`: **`.15b.2` landed — the seventh-surface metric + repo-owned gate.**
  ...
  byte-identical** (default-off). Banked clean `/tmp/anvil-mux-if-gate-r1`
...
- `2026-06-22`: **`.15b.1` landed — the LIVE seventh structured surface (the first
  ...
  `cargo test --lib` 605→615 incl. 10 new proofs, snapshots 6/6). Forced
  `mux_if_emit_prob=1.0` sweep (`/tmp/anvil-muxif-genproof.*`, 5 seeds): every plain
...
- `2026-06-22`: **`.13c` landed — the user-facing docs closeout of the first
  *deepening* of the sixth surface (wider `k>2` multi-output `task automatic`
  ...
  `/tmp/anvil-mo-k3-gate-r1`); `KNOWLEDGE_MAP.md` regenerated (64 facts / 589 → 593
...
- `2026-06-22`: **`.13b` landed — the LIVE `k>2` widening of the sixth surface (the
  ...
  **No emitter / config / metric / schema / knob change** — the emitter was already
  ...
  default `0.0` path never calls the pass). Gate re-bank `/tmp/anvil-mo-k3-gate-r1`
...
- `2026-06-22`: **`.12b.2b` landed — the repo-owned `tool_matrix
  ...
  **Banked clean** `/tmp/anvil-multi-output-task-gate-r1` (3 scenarios / 12 modules
...
- `2026-06-22`: **`.12b.1` landed — the multi-output combinational `task automatic`
  ...
  (`/tmp/anvil-mo-sweep/`, 4 seeds): `__mt(` fires 4/5, Verilator `-Wall` Δ=0 vs
...
- `2026-06-17`: **`.10b.1` landed — the multi-gate-cone `function automatic` live
  ...
  Forced `cone_function_emit_prob=1.0` sweep (`/tmp/anvil-cf-sweep/`, 8 seeds): 18
