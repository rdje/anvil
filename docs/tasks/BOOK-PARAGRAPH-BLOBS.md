...
| `.3b` | `BOOK-PARAGRAPH-BLOBS.3b — convert the capability roll-calls to lists; oversized mass down 63 %` | Book + `scripts/` + docs only ⇒ DUT byte-identical. Clause sequence proven identical; four controls. Also repaired four **mid-sentence** breaks `.1` shipped. |
