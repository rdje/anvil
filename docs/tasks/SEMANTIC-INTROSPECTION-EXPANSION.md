...
- ID: `SEMANTIC-INTROSPECTION-EXPANSION.9`
  ...
  Result: `(in progress — .9a design landed; .9b impl pending)`
...
**Active frontier: `.9b.1`** (the pure `node_drivers` core), after `.9a` landed its
design. **Seven** derived queries are already delivered end-to-end —
