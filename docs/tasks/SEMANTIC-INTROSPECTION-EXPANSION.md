...
**No active frontier.** **Five** derived queries are now delivered end-to-end —
...
The tree stays `active` (nothing retired): further derived-query kinds remain
open-ended breadth (none named, not a blocker). The next lane is owner-directed / PNT.
