...
- Created: `2026-05-24`
- Last updated: `2026-05-24` (**`.2` done** — IR extension + emitter K≥2 support landed; K=1 byte-identical confirmed by snapshots + book_examples; 4 new lib unit proofs)
