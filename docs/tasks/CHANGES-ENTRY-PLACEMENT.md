...
- ID: `CHANGES-ENTRY-PLACEMENT.5`
  ...
  Commit: `1cd46c3` — `CHANGES-ENTRY-PLACEMENT.5 — the authoring-path check, registered`
...
| --- | --- | --- |
| `CHANGES-ENTRY-PLACEMENT.5` | `1cd46c3` — `CHANGES-ENTRY-PLACEMENT.5 — the authoring-path check, registered` | Implements `0045` as the **tenth** registered doctrine. Historical scan and all three `0045` controls **reproduced** (plus three more and a `0037` vacuity probe). **Not scope-aware**, by design. Tree **closed**. |
