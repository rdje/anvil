...
## Calibration notes
### Phase 4 r70 extends the depth-5 axis with recursive non-top parent-port-composed parent outputs without helpers or parent-local state downstream-clean
